...
# Generated: Wed May  8 18:10:52 2019
##################################################
...
class AptRx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "AptRx")
        ...
        self.tab.addTab(self.tab_widget_2, "Demodulacion AM")
        ...
        self._af_gain_range = Range(0, 3, .1, 1., 100)
        ...
        self.tab_layout_1.addWidget(self._qtgui_freq_sink_x_0_0_0_win)
        ...
        self.connect((self.band_pass_filter_0, 0), (self.qtgui_time_sink_x_0_1_0, 0))    
...
def main(top_block_cls=AptRx, options=None):
